...
export const defaultPromptTemplates: PromptTemplate[] = [
  {
    key: "geo",
    label: "GEO 风格调优模板",
    content: "按 GEO 12 维度权重体系改造：证据引用层 43%（权威引语 16 / 统计数据 14 / 可引用性 13）、结构规范性 12、表达流畅度 10、语义密度 8、权威信号 8、专业术语 6、鲁棒性 5、跨域连接 4、易懂表达 3。直接改写成可独立发布的完整文章，不使用‘原文提到/强调/给出’等转述口吻；信息不足时用 [建议补充：...] 标注，不编造数据、引用、案例。80 分以上合格。",
  },
  {
    key: "zhihu",
    label: "知乎平台改写模板",
